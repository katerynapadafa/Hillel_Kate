...
import TodosFormView from '../view/TodosFormView'
import TodosListView from '../view/TodosListView'
...
export default class TodosController {
    constructor($container) {
        ...
        this._todosList.fetchList().then(() => this._todosListView.renderList(this._todosList.list));
    }
    toggleTodo(id) {
    ...
    createTodo(newTodo) {
        this._todosList.createTodo(newTodo).then(() =>
            this._todosListView.renderList(this._todosList.list))
    }
